...
public interface IUserRepository {
    ...
    MutableLiveData<Result> getUser(String firstName, String lastName, String username, String email, String password, int id_avatar, boolean isUserRegistered);
    ...
    void signUp(String firstName, String lastName, String username, String email, int id_avatar, String password);
